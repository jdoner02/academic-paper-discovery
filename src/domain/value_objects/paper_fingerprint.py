...
class PaperFingerprint:
    ...
    def _normalize_title(title: str) -> str:
        ...
        stopwords = {
            ...
            'to', 'was', 'were', 'will', 'with', 'the', 'using', 'based'
        }
    ...
    def __eq__(self, other) -> bool:
        ...
        if (self.primary_identifier.startswith(('doi:', 'arxiv:', 'pmid:')) and 
            other.primary_identifier.startswith(('doi:', 'arxiv:', 'pmid:'))):
        ...
        if (self.primary_identifier.startswith('composite:') and 
            other.primary_identifier.startswith('composite:')):
            return (self.primary_identifier == other.primary_identifier and
                    self.title_hash == other.title_hash and
                    self.author_hash == other.author_hash and
    ...
    def __hash__(self) -> int:
        ...
        if self.primary_identifier.startswith(('doi:', 'arxiv:', 'pmid:')):
            ...
            return hash((self.primary_identifier, self.title_hash, 
                        self.author_hash, self.publication_year))
    ...
    def __repr__(self) -> str:
        ...
        """
        return (f"PaperFingerprint(primary_identifier='{self.primary_identifier}', "
